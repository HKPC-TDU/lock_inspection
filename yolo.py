...
CWD = '/Users/eric/Desktop/Eric_Solution/project_folder/pj/lockp'
CWD = os.getcwd()
history_model_folder = "./model_data"
p_model_name = 'ep450-loss0.621-val_loss1.252.pth'
fontp = '{CWD}{input_path}/model_data/simhei.ttf'
...
class YOLO(object):
    def set_input_path(self, history_model_folder):
    ...
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        # /Users/eric/Desktop/Eric_Solution/project_folder/pj/lockp/yolov4-tiny-pytorch-master/logs/ep240-loss4.516-val_loss4.155.pth
        #"model_path"        : f'{CWD}{input_path}logs/{p_model_name}',
        "model_path"        : f'{history_model_folder}/logs/{p_model_name}',
        "classes_path"      : f'{history_model_folder}/classes.txt',
        #---------------------------------------------------------------------#
        #   anchors_path代表先验框对应的txt文件，一般不修改。
        #   anchors_mask用于帮助代码找到对应的先验框，一般不修改。
        #---------------------------------------------------------------------#
        "anchors_path"      : f'{history_model_folder}/model_data/yolo_anchors.txt',
    ...
    def detect_image(self, image, crop = False, count = False):
        ...
        #   设置字体与边框厚度
        #---------------------------------------------------------#
        font        = ImageFont.truetype(font=fontp, size=np.floor(3e-2 * image.size[1] + 0.5).astype('int32'))
