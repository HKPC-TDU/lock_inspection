...
def cpu_eric_train(a,b,c,d,e):
    ...
    #   DDP模式：       (Distrbuted Data Parallel)
    #       设置            distributed = True
    ...
    #---------------------------------------------------------------------#
    classes_path    = f'/home/ryan/Documents/Data/LockData/classes.txt'
    classes_path = '/Users/eric/Desktop/Eric_Solution/project_folder/New folder/lockp/LockData/classes.txt'
    classes_path = a
    # 'model_data/voc_classes.txt'
    anchors_path    = '/Users/eric/Desktop/Eric_Solution/project_folder/New folder/lockp/yolov4-tiny-pytorch-master/model_data/yolo_anchors.txt'
    anchors_path = b
    ...
    #----------------------------------------------------------------------------------------------------------------------------#
    model_path      = '/home/ryan/Documents/Code/yolo4vtiny/yolov4-tiny-pytorch-master/logs/ep450-loss0.621-val_loss1.252.pth'
    model_path = '/Users/eric/Desktop/Eric_Solution/project_folder/New folder/lockp/yolov4-tiny-pytorch-master/logs/ep450-loss0.621-val_loss1.252.pth'
    model_path = d
    #------------------------------------------------------#
    #   input_shape     输入的shape大小，一定要是32的倍数
    #------------------------------------------------------#
    input_shape     = [3072, 4096]
    ...
    train_annotation_path   = r'/home/ryan/Documents/Data/LockData/Annotation/train_label.txt'
    val_annotation_path     = r'/home/ryan/Documents/Data/LockData/Annotation/valid_label.txt'
    
    train_annotation_path, val_annotation_path     = c
    #------------------------------------------------------#
    #   设置用到的显卡
    #------------------------------------------------------#
    ...
    if True:
        ...
        lr_limit_min    = 3e-6 if optimizer_type == 'adam' else 5e-4
