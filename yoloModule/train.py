...
def eric_train(a,b,c):
    ...
    #---------------------------------------------------------------------#
    classes_path    = r'/home/shjas/eric/project_hkpc/lockpic/LockData/classes.txt'
    ...
    anchors_path = '/home/shjas/eric/project_hkpc/lockpic/yolov4-tiny-pytorch-master_/yolov4-tiny-pytorch-master/model_data/yolo_anchors.txt'
    ...
    train_annotation_path   = r'/home/shjas/eric/project_hkpc/lockpic/LockData/Annotation/train_label.txt'
    val_annotation_path     = r'/home/shjas/eric/project_hkpc/lockpic/LockData/Annotation/valid_label.txt'
    # train_annotation_path, val_annotation_path = get_anno_path()
